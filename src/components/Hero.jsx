    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
        ...
        <p className={`${styles.paragraph} ml-2`}>
          <span className='text-white'>2000+</span> Trusted Companies {" "}
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our experts use a proven methodology to find the perfect chat app tailored to your unique communication needs.</p>
    </div>
